...
pub const handlePostWorkspacePrefsResponse = mod.handlePostWorkspacePrefsResponse;
...
pub const handleListArtifactsResponse = mod.handleListArtifactsResponse;
pub const handleGetArtifactResponse = mod.handleGetArtifactResponse;
pub const handlePostUploadResponse = mod.handlePostUploadResponse;
pub const handlePostOnboardingSourceArtifactResponse = mod.handlePostOnboardingSourceArtifactResponse;
pub const handleReingestArtifactResponse = mod.handleReingestArtifactResponse;
pub const handlePostBomResponse = mod.handlePostBomResponse;
pub const handlePostBomXlsxResponse = mod.handlePostBomXlsxResponse;
pub const handleGetBomResponse = mod.handleGetBomResponse;
pub const handleGetDesignBomListResponse = mod.handleGetDesignBomListResponse;
pub const handleGetDesignBomTreeResponse = mod.handleGetDesignBomTreeResponse;
pub const handleGetDesignBomItemsResponse = mod.handleGetDesignBomItemsResponse;
pub const handleGetDesignBomComponentsResponse = mod.handleGetDesignBomComponentsResponse;
pub const handleGetDesignBomCoverageResponse = mod.handleGetDesignBomCoverageResponse;
pub const handleFindPartUsageResponse = mod.handleFindPartUsageResponse;
pub const handleBomGapsResponse = mod.handleBomGapsResponse;
pub const handleBomImpactAnalysisResponse = mod.handleBomImpactAnalysisResponse;
pub const handlePostSoupResponse = mod.handlePostSoupResponse;
pub const handlePostSoupXlsxResponse = mod.handlePostSoupXlsxResponse;
pub const handleGetSoupListResponse = mod.handleGetSoupListResponse;
pub const handleGetSoupComponentsResponse = mod.handleGetSoupComponentsResponse;
pub const handleGetSoupGapsResponse = mod.handleGetSoupGapsResponse;
pub const handleGetSoupLicensesResponse = mod.handleGetSoupLicensesResponse;
pub const handleGetSoupSafetyClassesResponse = mod.handleGetSoupSafetyClassesResponse;
...
pub const handleReportDesignBomMd = mod.handleReportDesignBomMd;
pub const handleReportDesignBomPdf = mod.handleReportDesignBomPdf;
pub const handleReportDesignBomDocx = mod.handleReportDesignBomDocx;
pub const handleReportSoupMd = mod.handleReportSoupMd;
pub const handleReportSoupPdf = mod.handleReportSoupPdf;
pub const handleReportSoupDocx = mod.handleReportSoupDocx;
